<div class="container-fluid" id="d_1" style="background-image:url({{URL::asset('images/bg/bg-full.png')}});">
    <div class="container">
        <div class="row">
            <div class="col-12 pl-lg-0 pl-0 pr-lg-3 pr-0 mb-5">
            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-12 text-center mb-5">
                        ...
                        <p style="line-height: 20px;width: 80%;margin: auto;">Công ty TNHH Nguyễn Thắng cung cấp các
                            dịch vụ kế toán uy tín, hoàn thành nhanh chóng,
                            kết quả chính xác, tư vấn miễn phí 24/7. tạo nên sự yên tâm với khách hàng và các đối
                            tác.</p>
                    </div>
